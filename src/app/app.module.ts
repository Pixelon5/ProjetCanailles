...
import { PorteeFormComponent } from './form/portee-form/portee-form.component';
import { ChiotFormComponent } from './form/chiot-form/chiot-form.component';
...
const routes: Routes = [
  ...
  {path: 'portees/new', component: PorteeFormComponent }
];
